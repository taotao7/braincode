  ...
  brains: [
    {
      ...
      roles: {
        ...
        coding: {
          ...
          fallbackModelIds: ["azure-openai-responses/gpt-5.5", "google/gemini-3.1-pro-preview"],
        ...
        frontend: {
          modelId: "anthropic/claude-sonnet-4-6",
          fallbackModelIds: ["google/gemini-3.1-pro-preview", "azure-openai-responses/gpt-5.5"],
          thinkingLevel: "medium",
          systemPrompt: "You are the frontend agent. Build accessible UI, manage component state, CSS/layout, browser behavior, and user-facing polish while following the product's visual language.",
        },
        backend: {
          modelId: "anthropic/claude-sonnet-4-6",
          fallbackModelIds: ["azure-openai-responses/gpt-5.5", "google/gemini-3.1-pro-preview"],
          thinkingLevel: "medium",
          systemPrompt: "You are the backend agent. Design and implement APIs, services, persistence boundaries, validation, error handling, and operationally safe server behavior.",
        },
        designer: {
          modelId: "google/gemini-3.1-pro-preview",
          fallbackModelIds: ["anthropic/claude-sonnet-4-6", "google/gemini-3-flash-preview"],
          thinkingLevel: "medium",
          systemPrompt: "You are the design agent. Produce practical UX flows, information architecture, visual direction, layout critique, and interaction guidance that engineers can implement.",
        },
        dba: {
          modelId: "google/gemini-3.1-pro-preview",
          fallbackModelIds: ["azure-openai-responses/gpt-5.5", "anthropic/claude-sonnet-4-6"],
          thinkingLevel: "high",
          systemPrompt: "You are the DBA agent. Review schema design, migrations, indexes, query plans, data integrity, backup/restore risk, and database performance.",
        },
        devops: {
          modelId: "anthropic/claude-sonnet-4-6",
          fallbackModelIds: ["google/gemini-3.1-pro-preview", "azure-openai-responses/gpt-5.5"],
          thinkingLevel: "medium",
          systemPrompt: "You are the DevOps agent. Handle CI/CD, deployment, containers, local environment, observability, infrastructure risk, and operational runbooks.",
        },
        security: {
          modelId: "google/gemini-3.1-pro-preview",
          fallbackModelIds: ["azure-openai-responses/gpt-5.5", "anthropic/claude-sonnet-4-6"],
          thinkingLevel: "high",
          systemPrompt: "You are the security agent. Analyze auth, permissions, secrets, injection, supply chain, threat models, and secure-by-default implementation details.",
        },
        qa: {
          modelId: "google/gemini-3-flash-preview",
          fallbackModelIds: ["anthropic/claude-sonnet-4-6", "google/gemini-3.1-pro-preview"],
          thinkingLevel: "low",
          systemPrompt: "You are the QA agent. Plan focused tests, edge cases, regression checks, reproducible bug reports, and practical verification strategy.",
        },
        research: {
          modelId: "google/gemini-3-flash-preview",
          fallbackModelIds: ["anthropic/claude-sonnet-4-6"],
        ...
        review: {
          modelId: "google/gemini-3.1-pro-preview",
          fallbackModelIds: ["anthropic/claude-sonnet-4-6", "azure-openai-responses/gpt-5.5"],
          thinkingLevel: "high",
