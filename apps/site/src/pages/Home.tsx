        ...
        <div className="container stack" style={{ gap: 48 }}>
          ...
          <div className="intent-graph-frame">
            ...
            <div className="intent-graph-scroll">
              <pre className="intent-graph" dangerouslySetInnerHTML={{ __html: "Intent · <span class=\"key\">brain</span> · primary=<span class=\"role\">backend</span> · routing=router-brain\nModel  · <span class=\"key\">cliproxyapi/claude-opus-4-7</span> · tools=parallel\n\n                            <span class=\"line\">┌─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">librarian</span>: gather context  <span class=\"line\">─┐</span>\n                            <span class=\"line\">├─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">security</span>:  auth risks      <span class=\"line\">─┤</span>\n                            <span class=\"line\">├─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">scout</span>:     repo map        <span class=\"line\">─┤</span>\n <span class=\"ok\">●</span> brain root (<span class=\"role\">backend</span>) <span class=\"line\">────┼─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">schemata</span>:  data contracts  <span class=\"line\">─┼─▶</span> <span class=\"active\">◐</span> <span class=\"role\">backend</span>: implement API <span class=\"line\">─┐</span>\n                            <span class=\"line\">├─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">docs</span>:      prior decisions <span class=\"line\">─┤</span>                             <span class=\"line\">│</span>\n                            <span class=\"line\">├─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">perf</span>:      hot path budget <span class=\"line\">─┤</span>                             <span class=\"line\">│</span>\n                            <span class=\"line\">└─▶</span> <span class=\"ok\">☑</span> <span class=\"role\">telemetry</span>: trace plan      <span class=\"line\">─┘</span>                             <span class=\"line\">│</span>\n                                                                                            <span class=\"line\">▼</span>\n                                                                                            <span class=\"pending\">☐</span> <span class=\"role\">review</span>: verify diff\n                                                                                            <span class=\"line\">│</span>\n                                                                                            <span class=\"line\">▼</span>\n                                                                                            <span class=\"pending\">☐</span> <span class=\"role\">qa</span>: regression checks\n                                                                                            <span class=\"line\">│</span>\n                                                                                            <span class=\"line\">▼</span>\n                                                                                            <span class=\"pending\">☐</span> <span class=\"role\">release</span>: tag &amp; ship\n\n<span class=\"dim\">Notes:\n  <span class=\"role\">librarian</span> → <span class=\"role\">backend</span>  support worker output feeds the primary task\n  <span class=\"role\">security</span>  → <span class=\"role\">backend</span>  auth risk notes guide the implementation\n  <span class=\"role\">scout</span>     → <span class=\"role\">backend</span>  repo map reveals integration seams\n  <span class=\"role\">schemata</span>  → <span class=\"role\">backend</span>  data contracts pin the API shape\n  <span class=\"role\">docs</span>      → <span class=\"role\">backend</span>  prior decisions cut redundant debate\n  <span class=\"role\">perf</span>      → <span class=\"role\">backend</span>  hot path budget shapes implementation\n  <span class=\"role\">telemetry</span> → <span class=\"role\">review</span>   trace plan helps verify the diff\n  <span class=\"role\">backend</span>   → <span class=\"role\">review</span>   review runs after implementation output exists\n  <span class=\"role\">review</span>    → <span class=\"role\">qa</span>       focused regression checks follow review\n  <span class=\"role\">qa</span>        → <span class=\"role\">release</span>  release awaits a green qa pass</span>" }} />
            </div>
          </div>
